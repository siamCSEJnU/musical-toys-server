...
async function run() {
  try {
    ...
    const musicalToys = client.db("musicalToys");
    const toysCollection = musicalToys.collection("toys");
    const gallery = musicalToys.collection("gallery");
...
app.listen(port, () => {
  console.log(`musical toys is running on ${port}`);
});
